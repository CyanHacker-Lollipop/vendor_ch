  ...
  ifeq ($(strip $(TARGET_ARCH)),arm)
    ...
    ifeq ($(strip $(TARGET_SM_KERNEL_DEFINED)),true)
      ...
      ifneq ($(filter %sabermod,$(SM_KERNEL)),)
        ...
        #export GRAPHITE_KERNEL_FLAGS (doppelpunkt)= \
                 #-fgraphite \
                 #-fgraphite-identity \
                 #-floop-flatten \
                 #-floop-parallelize-all \
...
#    LOCAL_DISABLE_GRAPHITE (doppelpunkt)= \
#      libunwind \
#      libFFTEm \
#      libicui18n \
#      libskia \
...
#      libunwind \
 ...
 # endif
  ...
  ifeq ($(strip $(ENABLE_PTHREAD)),true)
    ...
    # Add more modules if needed for devices in a device make file somewhere with
    # LOCAL_DISABLE_PTHREAD (doppelpunkt)=
