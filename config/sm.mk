...
ifeq ($(strip $(HOST_OS)),linux)
  ...
  ifeq ($(strip $(TARGET_ARCH)),arm)
    ...
    TARGET_ARCH_LIB_PATH := $(ANDROID_BUILD_TOP)/prebuilts/gcc/$(HOST_PREBUILT_TAG)/arm/arm-linux-androideabi-$(TARGET_SM_AND)-sm/lib/gcc/arm-linux-androideabi/$(TARGET_LIB_VERSION).x-sabermod

    # Path to ROM toolchain
    SM_AND_PATH := prebuilts/gcc/$(HOST_PREBUILT_TAG)/arm/arm-linux-androideabi-$(TARGET_SM_AND)-sm
    ...
    ifeq ($(strip $(TARGET_SM_KERNEL_DEFINED)),true)
      ...
      SM_KERNEL_PATH := prebuilts/gcc/$(HOST_PREBUILT_TAG)/arm/arm-eabi-$(TARGET_SM_KERNEL)-sm
