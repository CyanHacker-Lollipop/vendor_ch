...
ifeq ($(strip $(HOST_OS)),linux)
  ifneq ($(filter arm arm64,$(TARGET_ARCH)),)
    ifeq ($(strip $(TARGET_ARCH)),arm)
      ...
      SM_AND_PATH := prebuilts/gcc/$(HOST_PREBUILT_TAG)/arm/arm-linux-androideabi-$(TARGET_GCC_AND)
      ...
      ifeq ($(strip $(TARGET_GCC_ARM_DEFINED)),true)
        ...
        SM_KERNEL_PATH := prebuilts/gcc/$(HOST_PREBUILT_TAG)/arm/arm-eabi-$(TARGET_GCC_ARM)
    ...
    ifeq ($(strip $(TARGET_ARCH)),arm64)
      ...
      # Path to toolchain
      SM_AND_PATH := prebuilts/gcc/$(HOST_PREBUILT_TAG)/aarch64/aarch64-linux-android-$(TARGET_GCC_AND)
      ...
      ifeq ($(strip $(TARGET_GCC_ARM_DEFINED)),true)
        ...
        # Path to kernel toolchain
        SM_KERNEL_PATH := prebuilts/gcc/$(HOST_PREBUILT_TAG)/aarch64/aarch64-$(TARGET_GCC_ARM)
