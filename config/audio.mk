#
# CyanHacker Audio Files
#

ALARM_PATH := vendor/ch/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/ch/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/ch/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/ch/prebuilt/common/media/audio/ui
